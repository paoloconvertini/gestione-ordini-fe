...
export class AccontoDialogComponent extends CommonListComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<AccontoDialogComponent>,
  ...
  // GETTER PERMESSI --------------
  get canSelezionaAcconti(): boolean {
    return this.auth.hasPerm('ordine.acconti.seleziona');
  }
  // --------------------------------
